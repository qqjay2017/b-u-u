...
import { camelCase } from '../../../src/uni_modules/battery-uniapp-ui/components/common/util'
...
export function MarkdownTransform(): Plugin {
  return {
    ...
    async transform(code, id) {
      ...
      const GITHUB_URL = 'https://github.com/Moonofweisheng/battery-uniapp-ui/tree/master'
      ...
      const componentUrl = `${GITHUB_URL}/src/uni_modules/battery-uniapp-ui/components/${componentName}`
