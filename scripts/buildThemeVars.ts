...
const tsFilePath = path.resolve(__dirname, '../src/uni_modules/battery-uniapp-ui/components/wd-config-provider/types.ts')
const scssFilePath = path.resolve(__dirname, '../src/uni_modules/battery-uniapp-ui/components/common/abstracts/variable.scss')
