<template>
  ...
  >
    <view class="bt-button__content">
      <view v-if="loading" class="bt-button__loading">
        <view class="bt-button__loading-svg" :style="loadingStyle"></view>
      </view>
      <wd-icon v-else-if="icon" custom-class="bt-button__icon" :name="icon" :classPrefix="classPrefix"></wd-icon>
      <view class="bt-button__text"><slot /></view>
    </view>
  </button>
</template>
